...
/obj/item/crowbar/suicide(var/mob/user as mob)
	user.visible_message("<span style=\"color:red\"><b>[user] beats [himself_or_herself(user)] in the head with a crowbar, like some kind of suicidal theoretical physicist.</b></span>")
